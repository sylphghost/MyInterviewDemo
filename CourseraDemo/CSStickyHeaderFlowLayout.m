...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    if (self.collectionView.dataSource != nil) {
        ...
        if ([self.cssDelegate respondsToSelector:@selector(layout:isSectionNeedsLeftAlighment:)]) {
            ...
            for (UICollectionViewLayoutAttributes *attributes in allItems) {
                ...
                BOOL isOpen = [self.cssDelegate layout:self isSectionNeedsLeftAlighment:indexPath.section];
                if (isOpen) {
                    if(attributes.representedElementCategory == UICollectionElementCategoryCell)
                    {
                        if (attributes.frame.origin.x == self.sectionInset.left) {
                            ...
                            newLeftAlignedFrame.origin.x = leftMargin + self.minimumInteritemSpacing;
