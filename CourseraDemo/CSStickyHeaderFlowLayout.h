...
@class CSStickyHeaderFlowLayout;

@protocol CSStickyHeaderFlowLayoutDelegate <NSObject>

- (BOOL)layout:(CSStickyHeaderFlowLayout *)layout isSectionNeedsLeftAlighment:(NSInteger)section;
...
@property (nonatomic) BOOL isOpenLeftModel;
@property (nonatomic, weak) id<CSStickyHeaderFlowLayoutDelegate> cssDelegate;
